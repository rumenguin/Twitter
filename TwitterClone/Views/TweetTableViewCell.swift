...
final class TweetTableViewCell: UITableViewCell {
    ...
    private func configureConstraints() {
        ...
        let tweetTextContentLabelConstraints = [
            ...
            tweetTextContentLabel.trailingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: -15), //for multiline and padding from trailing
        ...
        let replyButtonConstraints = [
            ...
            replyButton.bottomAnchor.constraint(equalTo: contentView.bottomAnchor, constant: -15), //pinning to bottom
        ]
