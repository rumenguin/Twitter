...
class ProfileDataFormViewController: UIViewController {
    ...
    private let avatarPlaceholderImageView: UIImageView = {
        ...
        imageView.isUserInteractionEnabled = true //like on tap gesture (tappable)
    ...
    override func viewDidLoad() {
        ...
        scrollView.addSubview(hintLabel) //adding hint label to scrollview
        scrollView.addSubview(avatarPlaceholderImageView)
        scrollView.addSubview(displayNameTextField)
        scrollView.addSubview(usernameTextField)
        scrollView.addSubview(bioTextView)
        scrollView.addSubview(submitButton)
        isModalInPresentation = true //preventing user from dismissing the sheet
    ...
    private func configureConstraints() {
        ...
        let submitButtonConstraints = [
            ...
            submitButton.bottomAnchor.constraint(equalTo: view.keyboardLayoutGuide.topAnchor, constant: -20) //see imp. (above keyboard)
        ]
...
extension ProfileDataFormViewController: UITextFieldDelegate {
    ...
    func textFieldDidBeginEditing(_ textField: UITextField) {
        //push scrollview upward while editing
        // - 100 bacause we get 100 points padding from the top(origin.y)
