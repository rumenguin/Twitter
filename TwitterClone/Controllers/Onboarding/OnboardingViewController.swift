...
//  TwitterClone
//
//  Created by RUMEN GUIN on 29/03/23.
//
...
final class OnboardingViewController: UIViewController {
    ...
    private func configureConstraints() {
        ...
        let createAccountButtonConstraints = [
            ...
            createAccountButton.centerXAnchor.constraint(equalTo: view.centerXAnchor), //middle of screen
            createAccountButton.topAnchor.constraint(equalTo: welcomeLabel.bottomAnchor, constant: 20),
            createAccountButton.widthAnchor.constraint(equalTo: welcomeLabel.widthAnchor, constant: -20), //horizontal padding on the button
